...
func defaultControlPlane() *extensionsv1alpha1.ControlPlane {
	return controlPlane(
		"floating-network-id",
		&kubevirt.ControlPlaneConfig{
			LoadBalancerProvider: "load-balancer-provider",
			CloudControllerManager: &kubevirt.CloudControllerManagerConfig{
...
func controlPlane(fnid string, cfg *kubevirt.ControlPlaneConfig) *extensionsv1alpha1.ControlPlane {
	return &extensionsv1alpha1.ControlPlane{
		...
		Spec: extensionsv1alpha1.ControlPlaneSpec{
			...
			InfrastructureProviderStatus: &runtime.RawExtension{
				Raw: encode(&kubevirt.InfrastructureStatus{
					Networks: kubevirt.NetworkStatus{
						FloatingPool: kubevirt.FloatingPoolStatus{
							ID: fnid,
						},
						Subnets: []kubevirt.Subnet{
							{
								ID:      "subnet-acbd1234",
								Purpose: kubevirt.PurposeNodes,
							},
						},
					},
				}),
...
var _ = Describe("ValuesProvider", func() {
	var (
		...
		checksums = map[string]string{
			...
			kubevirttypes.CloudProviderConfigCloudControllerManagerName: "08a7bc7fe8f59b055f173145e211760a83f02cf89635cef26ebb351378635606",
		}
	...
	Describe("#GetConfigChartValues with Classes", func() {
		It("should return correct config chart values", func() {
			...
			cp := controlPlane(
				...
				&kubevirt.ControlPlaneConfig{
					LoadBalancerProvider: "load-balancer-provider",
					LoadBalancerClasses: []kubevirt.LoadBalancerClass{
						{
							Name:             "test",
