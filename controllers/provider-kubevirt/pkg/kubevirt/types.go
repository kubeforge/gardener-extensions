...
const (
	// Name is the name of the KubeVirt provider.
	...
	// KubeConfig is a constant for the key in a cloud provider secret that holds the KubeVirt kubeconfig.
	Kubeconfig = "kubeconfig"
	// Namespace is a constant for the key in a cloud provider secret that holds the KubeVirt namespace.
	Namespace = "namespace"
