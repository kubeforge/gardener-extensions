	...
	Objects: []*chart.Object{
		{
			...
			Name: kubevirttypes.CloudProviderConfigName,
		},
	},
}
...
var ccmChart = &chart.Chart{
	...
	Images: []string{kubevirttypes.HyperkubeImageName},
	Objects: []*chart.Object{
...
func (vp *valuesProvider) GetConfigChartValues(
	...
	infraStatus := &kubevirt.InfrastructureStatus{}
...
func getConfigChartValues(
	...
	subnetID, err := helper.FindSubnetByPurpose(infraStatus.Networks.Subnets, kubevirt.PurposeNodes)
	if err != nil {
	...
	return map[string]interface{}{
		...
		"authUrl":           cluster.CloudProfile.Spec.KubeVirt.KeyStoneURL,
		"dhcpDomain":        cluster.CloudProfile.Spec.KubeVirt.DHCPDomain,
		"requestTimeout":    cluster.CloudProfile.Spec.KubeVirt.RequestTimeout,
	}, nil
}
...
func getCCMChartValues(
	...
	values := map[string]interface{}{
		...
		"podAnnotations": map[string]interface{}{
			...
			"checksum/configmap-cloud-provider-config": checksums[kubevirttypes.CloudProviderConfigName],
		},
	}
