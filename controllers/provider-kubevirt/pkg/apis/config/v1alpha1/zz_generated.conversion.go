...
import (
	...
	config "github.com/gardener/gardener-extensions/controllers/provider-kubevirt/pkg/apis/config"
...
func RegisterConversions(s *runtime.Scheme) error {
	if err := s.AddGeneratedConversionFunc((*CloudProfileMapping)(nil), (*config.CloudProfileMapping)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_CloudProfileMapping_To_config_CloudProfileMapping(a.(*CloudProfileMapping), b.(*config.CloudProfileMapping), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.CloudProfileMapping)(nil), (*CloudProfileMapping)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_CloudProfileMapping_To_v1alpha1_CloudProfileMapping(a.(*config.CloudProfileMapping), b.(*CloudProfileMapping), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_CloudProfileMapping_To_config_CloudProfileMapping(in *CloudProfileMapping, out *config.CloudProfileMapping, s conversion.Scope) error {
	out.Name = in.Name
	out.Image = in.Image
	return nil
}
...
func Convert_v1alpha1_CloudProfileMapping_To_config_CloudProfileMapping(in *CloudProfileMapping, out *config.CloudProfileMapping, s conversion.Scope) error {
	return autoConvert_v1alpha1_CloudProfileMapping_To_config_CloudProfileMapping(in, out, s)
}

func autoConvert_config_CloudProfileMapping_To_v1alpha1_CloudProfileMapping(in *config.CloudProfileMapping, out *CloudProfileMapping, s conversion.Scope) error {
	out.Name = in.Name
	out.Image = in.Image
	return nil
}
...
func Convert_config_CloudProfileMapping_To_v1alpha1_CloudProfileMapping(in *config.CloudProfileMapping, out *CloudProfileMapping, s conversion.Scope) error {
	return autoConvert_config_CloudProfileMapping_To_v1alpha1_CloudProfileMapping(in, out, s)
}
...
func autoConvert_v1alpha1_MachineImage_To_config_MachineImage(in *MachineImage, out *config.MachineImage, s conversion.Scope) error {
	...
	out.CloudProfiles = *(*[]config.CloudProfileMapping)(unsafe.Pointer(&in.CloudProfiles))
	return nil
}
...
func autoConvert_config_MachineImage_To_v1alpha1_MachineImage(in *config.MachineImage, out *MachineImage, s conversion.Scope) error {
	out.Name = in.Name
	out.Version = in.Version
	out.CloudProfiles = *(*[]CloudProfileMapping)(unsafe.Pointer(&in.CloudProfiles))
	return nil
}
