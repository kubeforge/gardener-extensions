...
import (
	...
	infrainternal "github.com/gardener/gardener-extensions/controllers/provider-kubevirt/pkg/internal/infrastructure"
...
func (a *actuator) updateProviderStatus(
	...
	status, err := infrainternal.ComputeStatus(config)
	if err != nil {
		return err
	}
